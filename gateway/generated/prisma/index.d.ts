...
export namespace Prisma {
  ...
  */
  ...
  export type SubscriberOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"slug" | "authUrl" | "authType" | "apiKey", ExtArgs["result"]["subscriber"]>
  ...
  export interface SubscriberDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const subscriberWithSlugOnly = await prisma.subscriber.findMany({ select: { slug: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Subscribers and only return the `slug`
     * const subscriberWithSlugOnly = await prisma.subscriber.createManyAndReturn({
     *   select: { slug: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Subscribers and only return the `slug`
     * const subscriberWithSlugOnly = await prisma.subscriber.updateManyAndReturn({
     *   select: { slug: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface SubscriberFieldRefs {
    readonly slug: FieldRef<"Subscriber", 'String'>
    readonly authUrl: FieldRef<"Subscriber", 'String'>
    readonly authType: FieldRef<"Subscriber", 'String'>
    readonly apiKey: FieldRef<"Subscriber", 'String'>
  }
  ...
  export type SubscriberWhereInput = {
    ...
    slug?: StringFilter<"Subscriber"> | string
    authUrl?: StringNullableFilter<"Subscriber"> | string | null
    authType?: StringNullableFilter<"Subscriber"> | string | null
    apiKey?: StringFilter<"Subscriber"> | string
  }

  export type SubscriberOrderByWithRelationInput = {
    slug?: SortOrder
    authUrl?: SortOrderInput | SortOrder
    authType?: SortOrderInput | SortOrder
    apiKey?: SortOrder
  }
  ...
  export type SubscriberScalarWhereWithAggregatesInput = {
    ...
    slug?: StringWithAggregatesFilter<"Subscriber"> | string
    authUrl?: StringNullableWithAggregatesFilter<"Subscriber"> | string | null
    authType?: StringNullableWithAggregatesFilter<"Subscriber"> | string | null
    apiKey?: StringWithAggregatesFilter<"Subscriber"> | string
  }
  ...
  export type SubscriberUpdateInput = {
    ...
    authType?: NullableStringFieldUpdateOperationsInput | string | null
